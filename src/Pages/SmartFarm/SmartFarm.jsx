...
const technologies = [
  { icon: Drone, title: 'Drone Farming', description: 'Advanced crop monitoring and precision spraying' },
  { icon: Droplets, title: 'Smart Irrigation', description: 'IoT-powered water management systems' },
  { icon: Brain, title: 'AI Solutions', description: 'Intelligent farming decisions and predictions' },
  { icon: Navigation, title: 'GPS Tracking', description: 'Precise field mapping and navigation' },
  { icon: Plant2, title: 'Vertical Farming', description: 'Space-efficient modern farming methods' },
