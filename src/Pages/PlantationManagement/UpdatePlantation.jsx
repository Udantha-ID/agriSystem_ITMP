// UpdatePlantation.jsx (full updated code)
...
export default function UpdatePlantation() {
  ...
  useEffect(() => {
    const plantation = mockPlantations.find(p => p.id === Number(plantId));
    if (plantation) {
      setFormData({
        projectName: plantation.projectname,
        type: plantation.type,
        landArea: plantation.TotalLandArea,
        startDate: plantation.startdate,
        harvestingDate: plantation.harvestingdate,
        location: plantation.location,
        employees: plantation.employee.toString(),
      });
    }
  }, [plantId]);
        ...
        <div className="max-w-4xl mx-auto mt-8">
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="flex items-center mb-8 pb-6 border-b border-emerald-100">
              ...
              <h1 className="text-3xl font-bold text-gray-800 ml-40">Update Plantation</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {/* ... (keep other form fields the same as original UpdatePlantation.jsx) */}
